    ...
    Route::group(['prefix' => 'Cashier'], function(){
        ...
        Route::group(['middleware' => 'custom:Cashier'], function(){
            ...
            Route::group(['middleware' => 'dashboard:Cashier'],function(){
                ...
                Route::get('/day/report','Cashier\DashboardController@getReport');
                Route::get('/shift/report','Cashier\DashboardController@getReportByShift');
...
Route::get('/sale/stock/{id}','inventory\inventoryController@saleStock');
