...
namespace App\Http\Controllers\Cashier\Kitchen;
...
class KitchenController extends Controller
{
    ...
    public function index(){
        $kitchen = Kitchen::all();
        return view('cashier.kitchen.kitchenListing')->with('kitchens', $kitchen);
    }

    //To show kitchen entry form
    public function create(){
        return view('cashier.kitchen.kitchen_form');
    }
    ...
    public function edit($id){
        ...
        return view('cashier.kitchen.kitchen_form')->with('kitchen',$record);
    }
...
//        user is not allowed to edit because the edited name already exists in database
    ...
    public function delete($id){
        ...
        return redirect()->action('Cashier\Kitchen\KitchenController@index'); //to redirect listing page
