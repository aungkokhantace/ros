...
class RoleController extends Controller
{
    ...
    public function create(){
        ...
        return view('cashier.user.Staff_Type')->with('modules',$modules);
    }
    public function store(StaffTypeRequest $request)
    {
        ...
        if($result['aceplusStatusCode'] ==  ReturnMessage::OK){
            return redirect()->action('Cashier\Staff\RoleController@index')
    ...
    public function edit($id){
        ...
        return view('cashier.user.Staff_Type')->with('roles', $roles)->with('permissions',$permissions)->with('modules',$modules);
