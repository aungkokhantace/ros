...
class BookingController extends Controller
{
    ...
    public function index(){
        ...
        return view('Backend.booking.index',compact('bookings','waiting','table','room','boooking_table','booking_room'));
    }
    ...
    public function ajaxBookingRequest()
    {
        ...
        return view('Backend.booking.bookingListing',compact('bookings','waiting','table','room'))->render();
    }
    ...
    public function store(){
        ...
        if(isset($table_id)){
            $result = $this->bookingRepository->saveBooking($paramObj,$table_id);
                ...
                return redirect()->action('Backend\Booking\BookingController@index')
    ...
    public function update(){
        ...
        try{
            ...
            DB::commit();
            return redirect()->action('Backend\Booking\BookingController@index')->withMessage(FormatGenerator::message('Success', 'Reservation successfully updated! ...'));
    ...
    public function tableRequest()
    {
        ...
        return view('Backend.booking.tables',compact('tables','warning','waiting'))->render();
    }
    public function roomRequest(){
        ...
        return view('Backend.booking.rooms',compact('rooms','warning','waiting'))->render();
    }
