...
class CategorySaleSummaryReportController extends Controller
{
    ...
    public function DailyDetailReport(){
        ...
        return view('Backend.report.SaleSummaryDetailReport')->with('orders',$orders)->with('start',$start)->with('end',$end)->with('category',$category);
    }
    ...
    public function saleSummaryDetailReportWithDate(){
        ...
        if($start_date == "1970-01-01"||$end_date == "1970-01-01"){
            ...
            return view('Backend.report.SaleSummaryDetailReport',compact('orders','start_date','end_date','category','child'));
        }
