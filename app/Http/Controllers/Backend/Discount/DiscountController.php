...
class DiscountController extends Controller
{
    ...
    public function index()
        {
            ...
            return view('Backend.discount.discount_listing', compact('discounts', 'items'));
        }
    ...
    public function edit($id)
    {
        ...
        $continent = $this->DiscountRepository->getContinent();
        return view('Backend.discount.discount', compact('resource', 'discount_edit', 'items','continent'));
    }
