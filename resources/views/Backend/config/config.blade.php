...
@section('content')
   ...
   <div class="container">
    <div class="col-md-8 user-border-left">
        ...
        @if(isset($record))
            {!! Form::open(array('url' => 'Backend/Config/update','method' => 'post','id'=>'config' ,'class'=> 'form-horizontal user-form-border','id'=>'general')) !!}
        @endif
        ...
        @if(isset($config))
            {!! Form::open(array('url' => 'Backend/Config/update','method' => 'post','id'=>'config', 'class'=> 'form-horizontal user-form-border','id'=>'general')) !!}
        @else
            {!! Form::open(array('url' => 'Backend/Config/store','method' => 'post','id'=>'config', 'class'=> 'form-horizontal user-form-border','id'=>'general')) !!}
        @endif
