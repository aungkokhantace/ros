        ...
        <table class="print-invoice">
            ...
            <tbody class="i-title">
                ...
                <tr class="tr-bottom-dashed i-title">
                    ...
                    <td class="text-right">{{ number_format($order->room_charge) }} </td>
                </tr>
                @endif
                
                <tr class="i-title">
                    <td colspan="3">Service Tax ({{ $config->service}} %)</td>
                    <td class="text-right">{{ $order->service_amount }}</td>
                </tr>
                ...
                <tr class="tr-bottom-dashed i-title">
                    ...
                    <td class="text-right">{{ $order->total_discount_amount }}</td>
                </tr>
                
                <tr class="tr-bottom-dashed i-title">
                    <td colspan="3">Net Amount</td>
                    <td class="text-right">{{ number_format($order->all_total_amount) }} </td>
                </tr>
                ...
                <tr class="tr-bottom-dashed i-title">
                    ...
                    <td class="text-right">{{ number_format($order->refund) }}</td>
                </tr>
