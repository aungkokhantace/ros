                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-5">
                            <div class="table-responsive">
                                <table class="table receipt-table">
                                    ...
                                    <tr>
                                        <td colspan="3" class="no-border"><b>Extra Charge</b></td>
                                        <td class="no-border"><input type="number" name="extra_charge" class="extra_charge" value="" style="width:70px ; border:none;" dir="rtl" readonly/></td>
                                    </tr>
                        ...
                        <div class="col-md-7 col-sm-7">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-11">
                                    <b>Extra Charge</b>
                                    <input type="number" name="extra_charge_input" class="form-control extra_charge">
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-1"></div>
                                <div class="col-md-11">
                                    <b>Extra Charge Remark</b>
                                    <input type="text" name="extra_charge_remark" class="form-control extra_charge_remark">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-5">
                        <div class="table-responsive">
                            <table class="table receipt-table">
                                ...
                                <tr>
                                    <td colspan="3" class="no-border"><b>Extra Charge</b></td>
                                    <td class="no-border">{{ $order->extra_charge }}</td>
                                </tr>
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-11">
                                <b>Extra Charge</b>
                                <input type="number" name="extra_charge" class="form-control extra_charge" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-11">
                                <b>Extra Charge Remark</b>
                                <input type="text" name="extra_charge_remark" class="form-control extra_charge_remark" disabled>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
        ...
        $(".print_check_box").change(function() {
            ...
            if(!ischecked){
                ...
                var total_amount = eval(total_amount) + eval(room_charge) + eval(service_tax) + eval(extra_charge);
                ...
                var total_amount = eval(sub_total_price) + eval(service_tax) + eval(gov_tax)+ eval(room_charge) + eval(extra_charge);
        ...
        $('input[name="extra_charge_input"]').on('input', function() {
            ...
            $('input[name="extra_charge"]').val($(this).val());        
