    ...
    <div class="row">
        <div class="container">
            <div class="col-md-12">
                ...
                {!! Form::open(array('url' => 'Cashier/Booking/store', 'class'=> 'form-horizontal','id'=>'bookingForm')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="input-group date dateTimePicker" data-provide="datepicker">
                                <input  type="text" class="form-control" id="date1" name="date" placeholder="Enter Booking Date" value="{{isset($date)? $date:Request::old('date')}}" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box">
                                            <span class="info-box-icon bg-lred" >
                                                <input type="checkbox" name="table_check[]" value="{{$table->id}}" style="margin-top: 29px;position: absolute;margin-left: -15px;"/>
                            ...
                            @if(isset($rooms))
                                @foreach($rooms as $room)
                                    <div class="col-md-4">
                                        <div class="info-box">
                                            <span class="info-box-icon bg-lred" >
                                                <input type="checkbox" name="room_check[]" value="{{$room->id}}" style="margin-top: 29px;position: absolute;margin-left: -15px;"/>
                                                <i class="ion ion-fork"></i><i class="ion ion-knife"></i>
