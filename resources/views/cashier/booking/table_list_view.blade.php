...
@section('content')
        ...
        <div class="container">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="/Cashier/Booking/tableListView">Table View</a></li>
                    <li role="presentation"><a href="/Cashier/Booking/roomListView">Room View</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="container" id="table-frame">
            @include('cashier.booking.tables')
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function ajaxCall() {
                $.ajax({
                    type: 'GET',
                    url: '/Cashier/Booking/tableRequest',
        ...
        $(document).ready(function(){
            //For Socket On
            var url     = "/Cashier/Booking/tableRequest";//Json Callback Url
