...
@section('content')
    ...
    <div class="col-md-12 user-border-left">
        <ul class="nav nav-tabs">
            <li role="presentation"><a href="/Cashier/Config/general_config">General Setting</a></li>
    ...
    <div class="col-md-8 user-border-left">
        ...
        @if(isset($record))
            ...
            {!! Form::open(array('url' => 'Cashier/Profile/update','method' => 'post', 'class'=> 'form-horizontal user-form-border','files'=> true, 'id'=>'profile')) !!}

        @endif

        {{--check whether update or insert--}}
        @if(isset($profile))
            {!! Form::open(array('url' => 'Cashier/Profile/update', 'class'=> 'form-horizontal user-form-border','files' => true, 'method'=>'post', 'id'=>'profile')) !!}
        @else
            {!! Form::open(array('url' => 'Cashier/Profile/store', 'class'=> 'form-horizontal user-form-border','files' => true, 'method'=>'post', 'id'=>'profile')) !!}
        @endif
