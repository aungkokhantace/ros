...
@section('content')
    <div class="col-md-8">
        ...
        {{--title--}}
        @if(isset($shift))
            {!! Form::open(array('url' => 'Cashier/Shift/update', 'method' => 'post','class'=> 'form-horizontal', 'id'=>'shift-validate')) !!}
        @else
            {!! Form::open(array('url' => 'Cashier/Shift/store', 'method' => 'post','class'=> 'form-horizontal', 'id'=>'shift-validate', 'onsubmit' => 'return validate();')) !!}
        @endif
