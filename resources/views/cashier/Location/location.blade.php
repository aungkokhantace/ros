...
@section('content')
    <div class="col-md-8 user-border-left">
        ...
        {{--check new or edit--}}
        @if(isset($location))
            {!! Form::open(array('url' => 'Cashier/Location/update', 'class'=> 'form-horizontal user-form-border','id'=>'kitchenForm')) !!}
        @else
            {!! Form::open(array('url' => 'Cashier/Location/store', 'class'=> 'form-horizontal user-form-border','id'=>'kitchenForm')) !!}
        @endif
