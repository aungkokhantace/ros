...
@section('content')
    <div class="col-md-8 user-border-left">
        ...
        {{--check new or edit--}}
        @if(isset($user))
            {!! Form::open(array('url' => 'Cashier/Staff/update', 'class'=> 'form-horizontal user-form-border','id' => 'staffEditForm','autocomplete'=>'off')) !!}

        @else
            {!! Form::open(array('url' => 'Cashier/Staff/store', 'class'=> 'form-horizontal user-form-border','id' => 'staffEntryForm','autocomplete'=>'off')) !!}
        @endif
