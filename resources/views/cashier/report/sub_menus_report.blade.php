     ...
     <div class="container">
          <div class="row date_button">
                <div class="col-md-11 date_row">
                    ...
                    <div class="col-md-12">
                        {!! Form::open(array('url' => 'Cashier/fav_set_date_report', 'method' => 'post', 'class'=> 'form-horizontal user-form-border')) !!}
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                            @if(isset($start_date))
                                @if($number=="")
                                    <a href={{'/Cashier/downloadsubReportWithDate/'.$start_date.'/'.$end_date}}><button class="btn btn-success btn_export">Export</button></a>
                                @else
                                    <a href={{'/Cashier/downloadsubReportWithDate/'.$start_date.'/'.$end_date.'/'.$number}}><button class="btn btn-success btn_export">Export</button></a>
                                @endif
                            @else
                                <a href={{'/Cashier/downloadsubReport'}}><button class="btn btn-success btn_export">Export</button></a>
                            @endif
                        </div>
                    </div>
                </div>
